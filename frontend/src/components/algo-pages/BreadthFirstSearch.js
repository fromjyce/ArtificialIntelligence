...
import '../../styles/algo-pages/BreadthFirstSearch.css';
...
const BreadthFirstSearch = () => {
    ...
    const [algorithmName] = useState('breadth_first_search');
    const leftLink = "/depth-first-search";
    const rightLink = "/informed-algorithm-list";
    ...
    return (
        <div className="british-museum-search-container">
            <div className="left-side-container">
                <h1 className='algorithm-title'>Breadth First Search</h1>
