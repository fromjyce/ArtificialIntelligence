...
import '../../styles/algo-pages/OracleSearch.css';
...
const OracleSearch = () => {
    ...
    const [algorithmName] = useState('oracle_search_method');
    const leftLink = "/beam-search-method";
    const rightLink = "/best-first-search";
    ...
    return (
        <div className="british-museum-search-container">
            <div className="left-side-container">
                <h1 className='algorithm-title'>Oracle Search</h1>
