...
const BranchAndBoundEL = () => {
    ...
    const [algorithmName] = useState('branch_and_bound_dead_horse');
    const leftLink = "/branch-bound-method";
    const rightLink = "/branch-bound-cost-heuristics-method";
    ...
    return (
        <div className="british-museum-search-container">
            <div className="left-side-container">
                <h1 className='algorithm-title'>Branch and Bound - Dead Horse</h1>
...
export default BranchAndBoundEL;