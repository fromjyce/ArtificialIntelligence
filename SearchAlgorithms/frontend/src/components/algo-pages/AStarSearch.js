...
import '../../styles/algo-pages/AStarSearch.css';
...
const AStarSearch = () => {
    ...
    const [algorithmName] = useState('a_star_search');
    const leftLink = "/branch-bound-cost-heuristics-method";
    const rightLink = "/a-o-star-search-method";
    ...
    return (
        <div className="british-museum-search-container">
            <div className="left-side-container">
                <h1 className='algorithm-title'>A Star Search</h1>
