...
import '../../styles/algo-pages/BeamSearch.css';
...
const BeamSearch = () => {
    ...
    const [algorithmName] = useState('beam_search_method');
    const [betaValue, setBetaValue] = useState('');
    const leftLink = "/hill-climbing-method";
    const rightLink = "/oracle-search-method";
    ...
    return (
        <div className="british-museum-search-container">
            <div className="left-side-container">
                <h1 className='algorithm-title'>Beam Search</h1>
                <form onSubmit={handleSubmit} className="form-container">
                    ...
                    <div>
                        <input
                            type="number"
                            name="beta"
                            placeholder="Beam width (beta value)"
                            value={betaValue}
