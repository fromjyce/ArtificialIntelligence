...
import '../../styles/algo-pages/HillClimbingSearch.css';
import DoubleFooter from './DoubleFooter';

const BranchAndBoundHC = () => {
    ...
    const [algorithmName] = useState('branch_and_bound_heuristics_cost');
    const leftLink = "/branch-bound-dead-horse-method";
    const rightLink = "/a-star-search-method";
    ...
    return (
        <div className="british-museum-search-container">
            <div className="left-side-container">
                <h1 className='algorithm-title'>Branch and Bound - Heuristics and Cost</h1>
...
export default BranchAndBoundHC;