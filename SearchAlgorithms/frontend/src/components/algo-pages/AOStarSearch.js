...
import '../../styles/algo-pages/AOStarSearch.css';
...
const AOStarSearch = () => {
    ...
    const [algorithmName] = useState('ao_star_search');
    const leftLink = "/a-star-search-method";
    const rightLink = "/";
    ...
    return (
        <div className="british-museum-search-container">
            <div className="left-side-container">
                <h1 className='algorithm-title'>AO Star Search</h1>
